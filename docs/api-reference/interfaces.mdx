...
```
*(See Core Concepts: [Dependency Injection](./../core-concepts/container.mdx))* 
...
```
*(See Core Concepts: [Registry Pattern](./../core-concepts/registry.mdx))* 
...
```
*(See Core Concepts: [Factory Pattern](./../core-concepts/factory.mdx))* 
...
```
*(See Services: [Logging Service](./../services/logging.mdx))* 
...
```
*(See Core Concepts: [Error Handling](./../core-concepts/error-handling.mdx))* 
...
export interface IConsoleLoggerOptions {
	level: ELoggerLogLevel; // Minimum level to log
